...
impl World {
    ...
    pub fn walk_block(&mut self, pos: IVec3, entity: &mut Entity) -> bool {
    ...
    pub fn walk_block_unchecked(&mut self, pos: IVec3, id: u8, _metadata: u8, entity: &mut Entity) {
        match id {
            block::FARMLAND => {
